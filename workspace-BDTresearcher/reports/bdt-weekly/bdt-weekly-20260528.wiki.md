...
**Word版下载：** https://www.feishu.cn/file/QI6cbHbSEoDzO3xzRvwcyNvSn0U

**覆盖周期：** 2026.05.22-05.28

**资料来源：** 同花顺、财联社电报、新华网科技、经济观察网、爱集微、电子发烧友、电子工程专辑、SearXNG近7天检索、iFinD新闻/公告/财务数据、上市公司公告及公开资料。

## 一、行业动态与发展总结

### 1. 近期政策变动

本周政策主线集中在科技创新、技术改造和设备更新。国家发改委近期明确将继续推动科技创新和技术改造再贷款项目清单筛选推送，公开信息显示今年科技创新和技术改造再贷款利率由1.75%降至1.25%，设备更新贷款财政贴息标准由1个百分点提升至1.5个百分点。这对半导体设备、材料、封测和IDM企业的意义不在于“多一项补贴”，而是把设备采购、产线升级、研发中试等资本开支转化为可被银行识别和承接的政策性融资场景。

全国层面仍把集成电路、人工智能、先进制造和供应链安全放在新质生产力框架下推进。结合本周AI算力、CPO、先进封装、国产设备和第三代半导体信息，政策方向正在从单点芯片补贴转向“算力基础设施、关键材料、核心设备、先进封装、软件和整机系统”的体系化支持。

综合影响闭环：政策信号指向设备更新和技术改造资金成本下降，经营含义是半导体企业更愿意推进设备采购、产线改造和国产替代验证；金融需求主要体现为中长期项目资金、短期备货周转、供应商付款和票据资产管理；平安银行可优先用科技创新和技术更新改造再贷款、平安租赁、银票极速贴现、商票e贴、付融通和数字财资切入，营销动作应从企业近期技改项目清单、设备供应商、票据池和客户回款周期入手。

### 2. 政府规划与产业方向

国家层面的产业方向可以概括为三条：一是AI算力基础设施继续拉动高端芯片、先进封装、存储、CPO和服务器连接件；二是设备、材料、EDA/IP等短板环节继续围绕国产替代和供应链安全推进；三是新能源汽车、数据中心、光伏储能和工业控制继续支撑功率半导体、SiC/GaN和车规芯片需求。

对银行而言，规划不是停留在产业叙事，而是落到融资科目：算力和先进封装带来设备采购、封测产能、测试设备和材料消耗；国产替代带来研发和认证周期资金占用；功率半导体和第三代半导体带来产线爬坡、库存和应收账款。客户经理应把政策支持方向转换成企业项目、订单、设备和付款方式四张清单。

### 3. 行业发展趋势

行业处于结构性上行和分化并存阶段。AI算力、先进封装、半导体设备、关键材料、功率器件和第三代半导体景气度相对更强；消费电子链条仍偏温和修复；资本市场方面，本周出现多家半导体上市公司重要股东减持计划，说明板块估值修复后分歧加大，银行授信不能简单跟随股价热度。

更值得银行关注的企业类型包括：有真实订单和在手产能的设备材料企业、进入核心客户供应链的封测和功率器件企业、具备地方项目和专精特新标签的中小企业、拥有稳定票据和应收账款场景的链主及其供应商。风险上要提前识别客户集中度、产能利用率不足、库存积压、设备折旧压力、股东减持和再融资不确定性。

### 4. 上下游产业链动态

上游设备材料继续受国产替代和设备更新政策支撑，测试设备、电子湿化学品、靶材、特气、光刻胶配套和封装材料值得重点关注；中游晶圆制造、先进封装和封测受AI芯片、Chiplet和国产算力需求带动，资金占用集中在设备、材料、人工和客户账期；下游汽车电子、工业控制、AI服务器、数据中心电源和光伏储能拉动功率器件和SiC/GaN需求。

资金占用最大的环节在设备采购、产线爬坡、封测备货和材料库存。适合平安银行切入的产品包括科技创新和技术更新改造再贷款、平安租赁、平安透、网上自由贷、银票极速贴现、商票e贴、付融通、国内信用证开证及融资、资产池和数字财资。

## 二、浙江地区动态与区域机会

### 1. 浙江政策与政府规划

浙江本周区域信号主要来自杭州半导体展会、钱塘芯谷产业平台和浙江“415X”先进制造业集群延续推进。2026杭州国际半导体与集成电路产业创新展览会近期在杭州大会展中心举办，公开信息显示展会由中国半导体行业协会指导、浙江省半导体行业协会等参与，反映杭州正在把集成电路展会、产业园区、创新平台和企业资源集中到同一招商与协同场景中。钱塘芯谷公开信息显示其规划面积约138平方公里，以半导体产业和未来产业为主导方向，承担浙江省、杭州市高水平建设高端集成电路产业的重要功能。

浙江省政府工作报告继续强调“两重”“两新”、设备更新、先进制造业集群和新质生产力方向。对本地企业的影响是，半导体企业的技改、设备更新、产业园区入驻、绿色制造和智能制造项目更容易与政策性资金、财政贴息和银行专项产品形成联动。

### 2. 浙江重点产业与区域机会

浙江半导体机会集中在杭州、宁波、嘉兴、衢州等区域。杭州重点看IDM、功率器件、测试设备、芯片设计和钱塘芯谷集成电路平台；宁波重点看先进封装、靶材、新材料和外贸型制造；嘉兴可关注化合物半导体和产业承接项目；衢州依托化工和材料基础，适合关注电子湿化学品、电子特气等上游材料。

客户经理扫客优先级建议：先扫杭州钱塘芯谷及长芯展参展/参会企业，再扫宁波先进封测和半导体材料上市公司上下游，第三步关注衢州电子化学品及嘉兴化合物半导体项目。企业类型上，优先选择专精特新、小巨人、高新技术企业、上市公司供应商、园区重点项目和有设备采购/票据/应收账款场景的企业。

### 3. 浙江上下游产业链动态

浙江上游以设备、材料、电子化学品和核心零部件为重点，代表企业包括长川科技、江丰电子、中巨芯等；中游以IDM、封测和功率器件为重点，代表企业包括士兰微、甬矽电子等；下游连接汽车电子、工业控制、智能物联、光伏储能、安防和AI算力设备。

本地产业链资金占用主要在三处：设备企业研发和订单交付、材料企业库存和客户认证、封测/IDM企业产线和应收账款。批量获客可以从核心企业供应商付款、票据开放银行、园区科创贷、设备更新再贷款和代发/口袋管家组合切入。

### 4. 银行展业机会

- 设备更新和技改项目：围绕钱塘芯谷、杭州长芯展参展企业和浙江重点制造项目，主推科技创新和技术更新改造再贷款、平安租赁、项目融资。
...
- **高层与团队背景：** 公开资料显示，董事长陈向东为公司联合创始人，大学本科，正高级工程师，长期深耕半导体产业；有公开媒体报道其具备复旦大学教育背景，具体专业及导师信息待核实。CFO/CTO公开细节需进一步从年报和尽调材料核实。
...
- 杭州长芯展和钱塘芯谷持续强化本地集成电路生态，士兰微具备链主和生态入口价值。
...
- **银行关注点：** 测试设备处于国产替代和先进封装扩张的上游环节，客户验证周期长、订单交付和研发投入占用资金，适合从订单、票据和供应商采购场景判断融资需求。

**推荐理由：**

- 先进封装、AI芯片和国产替代拉动测试设备需求，行业景气较设计端更具结构性。

- 本周国家科技创新和技术改造再贷款政策继续加码，设备企业自身研发投入和客户设备采购均可形成银行业务入口。

- 杭州长芯展提升本地设备、材料、封测企业对接密度，长川科技可作为设备链条重点拜访对象。
...
半导体测试设备今年受先进封装和国产替代拉动明显，我们想围绕贵司订单交付、研发备货和票据结算三类场景做一版资金方案，先看能否降低短期周转成本。
...
- **基本情况：** 2017年成立于宁波余姚中意宁波生态园，主营集成电路封装测试，定位先进封装和高端封测服务，是浙江先进封测环节的重要上市公司。SearXNG近7天结果显示，公司招聘与公开信息仍强调浙江重点智能制造项目和封测业务。
...
电子化学品是晶圆制造国产化绕不开的材料环节。我们想从贵司项目建设、原料采购和下游客户账期三个维度做资金需求拆解，看看再贷款、票据和供应链工具能否组合使用。

**风险提示：**

电子化学品涉及安全环保监管、客户认证周期和产能利用率风险；需重点核查负债结构、项目进度、环保合规、客户集中度和现金流。

## 四、客户经理行动建议

- 今日优先拜访杭州士兰微电子股份有限公司、杭州长川科技股份有限公司，围绕设备更新、技改、订单交付、票据池和供应商付款做需求访谈。

- 本周内跟进甬矽电子（宁波）股份有限公司、宁波江丰电子材料股份有限公司，重点从应收账款、跨境结算、进口设备/原料和商票贴现切入。

- 对中巨芯科技股份有限公司先做项目和交易结构摸底，确认技改扩产、电子化学品原料采购、下游客户账期和地方国资平台协同空间。

- 准备产品包：科技创新和技术更新改造再贷款、平安租赁、平安透、银票极速贴现、商票e贴、付融通、数字财资、跨境支付结算、平安避险和平安薪。

- 内部联动公司授信、交易银行、普惠金融、跨境金融、平安租赁和平安证券资源，先做“一企一场景”方案，避免泛泛推产品。
